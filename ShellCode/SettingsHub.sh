...
# sysctl.conf
#=======================================================================================
sudo su -c "echo 'net.core.default_qdisc=fq' > /etc/sysctl.conf"
sudo su -c "echo 'net.ipv4.tcp_congestion_control=bbr' >> /etc/sysctl.conf"
...
sudo sysctl -p
#To check available congestion control algorithms:
sudo sysctl net.ipv4.tcp_available_congestion_control
#To check the current congestion control algorithm in use:
